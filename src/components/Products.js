							...
							return(
								<div key={index} className='tape'>
									...
									<div className='tapeInfo'>
										{tapes.productType?<p><b>Product Type:</b> {tapes.productType}</p>:""}
										{tapes.color?<p><b>Color:</b> {tapes.color}</p>:""}
										{tapes.length?<p><b>Length:</b> {tapes.length}</p>:""}
										{tapes.width?<p><b>Width:</b> {tapes.width}</p>:""}
										{tapes.productType?<p><b>Product Type:</b> {tapes.productType}</p>:""}
									</div>
